...
import user11681.wheel.extension.WheelLoomExtensionBase;
...
public interface WheelLoomPlugin<E extends WheelExtension & WheelLoomExtensionBase> extends WheelPluginBase<E> {
    ...
    private File sourcePath() {
        return (File) Uncheck.handle(() -> Invoker.bind(this.task(this.extension().genSources()), "getMappedJarFileWithSuffix", File.class, String.class).invoke("-sources.jar"));
    }
